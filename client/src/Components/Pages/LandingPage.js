            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <p className="lead">
                            Can't find what you are looking for? You can create one yourself. You choose if to keep it private, share it with the world or later on just delete it from existence. And it is all for free.
                        </p>
                        <div className="row">
                            <div className="col-md-6">
