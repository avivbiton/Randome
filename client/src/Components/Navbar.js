...
function UserDropdown({ user }) {
    return (
        <div className="dropdown mx-2">
            <img className="nav-item dropdown-toggle rounded-circle navbar-brand" style={{ width: "3.5rem", maxHeight: "4rem" }} src={user.picture} id="dropdownMenuButton" alt="user" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" />
